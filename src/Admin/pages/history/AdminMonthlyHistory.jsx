...
const AdminMonthlyHistory = () => {
    ...
    if (data) {
        const monthlyBill = data.data.filter((bill) => {
            const billDate = new Date(bill.created_at);
            if (today.getMonth() === billDate.getMonth() && today.getFullYear() === billDate.getFullYear()) {
                return bill;
            }
        });
                ...
                <div>
                    <div className="mt-8">
                        <div className="flex items-center justify-between">
                            <h1 className="text-3xl font-bold"> {today.toLocaleString('default', { month: 'long' })} History</h1>
                            <hr className="my-2" />
                        ...
                        <div className="mt-8">
                            <div className="card">
                                <DataTable value={monthlyBill} expandedRows={expandedRows} onRowToggle={(e) => setExpandedRows(e.data)}
...
export default AdminMonthlyHistory;
