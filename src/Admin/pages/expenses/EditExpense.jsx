...
const EditExpenses = () => {
  ...
  const { data, mutate, error } = useSWR(`${APIURL}expenses/${params.id}`, fetcher);

  const { data: dealerData } = useSWR(APIURL + "dealers", fetcher);
      ...
      <div>
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const res = await fetch(`${APIURL}expenses/${params.id}`, {
              method: "post",
              body: formData,
              headers: {
                      ...
                      >
                        ...
                        {!dealerData ? (
                          ...
                          dealerData.data.map((dealer) => {
                            return (
                              <option value={dealer.id} key={dealer.id} selected={dealer.id == values.dealer_id ? true : false}>
                                {dealer.name}
                              </option>
                            );
                          })
